...
function main_product_category( $atts, $content = ""){
	...
	if ( $terms && $show != 'post') {
		...
		if ( $query->have_posts() ) :
			$i = 0;
			$result .= '<form class="woocommerce-items-perpage" method="get">
	<label>Show: </label>
	<div class="selector" style="width: 124.2px;">
	...
	<label>Sort by:</label>
	<div class="selector" style="width: 205.2px;">
	...
	<p class="clearfix">&nbsp;</p>
	<div class="popular-post list_post row" data-meta="'.$meta.'"><ul class="clearfix row">';
		...
		if($i > $per_page-1){
			add_action('wp_footer',get_post_ajax($order_by,$per_page),25);
		}
	}
